...
- Dispatch: `.relays/s4/s4-dispatch/PLAN-orchestrator-planner-20260705-000914.md`
- Boot: `.relays/s4/boot/s4-boot-orchestrator-planner/SITREP-orchestrator-planner-20260705-000914.md`
...
- Baseline: `frank/` on `main`, clean, tag `s3-close`; riding owed item = `OI-S3-CONFIG-CHANGE` alone (`master-docs/master/RECONCILE.md` § S3).
