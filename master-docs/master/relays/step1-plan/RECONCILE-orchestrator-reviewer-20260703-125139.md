...
- Planner relay lint: `python3 ~/.codex/skills/tools/relay-lint.py master/relays/step1-plan/PLAN-orchestrator-planner-20260703-124552.md` -> OK.
...
- New relay lint: `python3 ~/.codex/skills/tools/relay-lint.py master/relays/step1-plan/RECONCILE-orchestrator-reviewer-20260703-125139.md` -> OK.
- Dispatch-root lint: `python3 ~/.codex/skills/tools/relay-lint.py --relay-root master/relays/step1-plan` -> OK.
