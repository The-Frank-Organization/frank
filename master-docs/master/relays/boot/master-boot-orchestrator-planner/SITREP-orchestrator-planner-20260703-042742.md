...
- `python3 ~/.claude/skills/tools/relay-lint.py master/relays/boot/master-boot-orchestrator-planner/SITREP-orchestrator-planner-20260703-042742.md` — (run below).
