...
- `python3 ~/.codex/skills/tools/relay-lint.py master/relays/c6-close/RECONCILE-orchestrator-planner-20260703-023511.md` - OK.
...
- `nl -ba master/domains/m-4-routing-policy/design/2026-06-29-routing-policy-design.md | sed -n '360,370p'` - verified m-4 locked target.
- `find master -maxdepth 1 -name 'c61*diff' -print` - only `master/c61-fix.diff` exists.
- `python3 ~/.codex/skills/tools/relay-lint.py master/relays/c6-close/RECONCILE-orchestrator-reviewer-20260703-023723.md` - OK after write.
