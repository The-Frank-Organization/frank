...
- `python3 ~/.claude/skills/tools/relay-lint.py master/relays/c5-claim-sweep-light/DESIGN-orchestrator-planner-20260702-132139.md` — OK
- `python3 ~/.claude/skills/tools/relay-lint.py --relay-root master/relays/c5-claim-sweep-light` — OK
