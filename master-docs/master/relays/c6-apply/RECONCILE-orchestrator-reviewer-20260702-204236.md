...
- `python3 ~/.codex/skills/tools/relay-lint.py master/relays/c6-apply/RECONCILE-orchestrator-planner-20260702-203823.md` - OK.
- `ls -la master/relays/c6-apply && tail -n 8 master/relays/INDEX.md` - revision relay and index row present.
- `nl -ba master/domains/m-7-conductor-core/design/2026-07-01-conductor-core-design.md | sed -n '152,160p;214,220p;267,272p'` - verified m-7 NF-S6 intact and NF-S7/CQ-2 widened.
