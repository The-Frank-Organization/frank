...
**Locked design-of-record (frank Step-1 foundation):** m-1 Trust & Identity + m-2 Forms & Determinism, **jointly**. Authoritative detail:
- `domains/m-1-trust-identity/design/2026-06-28-trust-identity-design.md` (rev2)
- `domains/m-2-forms-determinism/design/2026-06-28-form-schema-design.md` (rev2)
