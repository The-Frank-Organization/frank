...
- `python3 ~/.codex/skills/tools/relay-lint.py master/relays/c4-cq-m1/DESIGN-planner-20260702-020100.md` -- OK
- `python3 ~/.codex/skills/tools/relay-lint.py master/relays/c4-cq-m1/DESIGN-REVIEW-implementer-20260702-020447.md` -- OK
- `python3 ~/.codex/skills/tools/relay-lint.py --relay-root master/relays/c4-cq-m1` -- OK
