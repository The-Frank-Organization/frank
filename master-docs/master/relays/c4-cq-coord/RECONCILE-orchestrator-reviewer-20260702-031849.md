...
- `python3 ~/.codex/skills/tools/relay-lint.py master/relays/c4-cq-coord/RECONCILE-orchestrator-reviewer-20260702-031849.md` -- OK
- `python3 ~/.codex/skills/tools/relay-lint.py --relay-root master/relays/c4-cq-coord` -- OK
- `for f in master/relays/c4-cq-gateconfig/*.md master/relays/c4-cq-m1/*.md master/relays/c4-cq-slotin/*.md; do python3 ~/.codex/skills/tools/relay-lint.py "$f" >/dev/null || echo "LINT_FAIL $f"; done` -- no output (all lint clean)
