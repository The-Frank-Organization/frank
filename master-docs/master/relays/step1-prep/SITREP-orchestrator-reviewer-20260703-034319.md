...
- `python3 ~/.codex/skills/tools/relay-lint.py master/relays/step1-prep/SITREP-orchestrator-planner-20260703-034013.md` - OK.
...
- `nl -ba master/domains/m-7-conductor-core/design/2026-07-01-conductor-core-design.md | sed -n '80,150p;240,290p;310,360p'` - checked m-7 guardrail/path absence and Step-1 acceptance context.
- `nl -ba master/domains/m-1-trust-identity/design/2026-06-28-trust-identity-design.md | sed -n '84,116p;220,242p'` - checked m-1 D5/tool-surface claim boundary.
- `nl -ba master/domains/m-2-forms-determinism/design/2026-06-28-form-schema-design.md | sed -n '274,286p;358,376p;520,546p'` - checked m-2 bounce/reason and related form surfaces.
...
- `python3 ~/.codex/skills/tools/relay-lint.py master/relays/step1-prep/SITREP-orchestrator-reviewer-20260703-034319.md` - OK after write.
- `python3 ~/.codex/skills/tools/relay-lint.py --relay-root master/relays/step1-prep` - OK after write.
