...
- `python3 ~/.claude/skills/tools/relay-lint.py master/relays/c4-cq-slotin/DESIGN-orchestrator-planner-20260702-012537.md` — OK
- `python3 ~/.claude/skills/tools/relay-lint.py --relay-root master/relays/c4-cq-slotin` — OK
