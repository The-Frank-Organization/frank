...
- `python3 ~/.claude/skills/tools/relay-lint.py master/relays/c5-claim-sweep-m-2/DESIGN-orchestrator-planner-20260702-132110.md` — OK
- `python3 ~/.claude/skills/tools/relay-lint.py --relay-root master/relays/c5-claim-sweep-m-2` — OK
