...
| `routing_record_kind` | routing_decision | m-4 §5:199-207 — Step-1 declares the one live token only; routing_deviation/routing_update stay v3.1-reserved, NOT declared |
...
| outcome_feedback_ref | id_ref | null-reserved v3.1 |
