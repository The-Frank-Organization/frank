...
**Status:** r4 — r2 pair-APPROVED (`s1-core-design-r2-review/DESIGN-REVIEW-implementer-20260703-152445.md`); r3 = the m-7 guide's two advisory should-fix folds (§9 fold-log; zero must-fix); r4 = one plan-review-driven envelope fix (§10 fold-log) — both bounded folds, no re-architecture, r2 lock content otherwise unchanged
