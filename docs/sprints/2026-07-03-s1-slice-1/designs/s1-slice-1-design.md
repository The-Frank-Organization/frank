...
**Status:** r3 — r2 pair-APPROVED (`s1-core-design-r2-review/DESIGN-REVIEW-implementer-20260703-152445.md`); r3 = the m-7 guide's two advisory should-fix folds (§9 fold-log; guide read `master/relays/s1-guide-design-read/SITREP-planner-20260703-154742.md`, zero must-fix) — sanctioned by the PROCEED-TO-PLAN supplement, no re-architecture, r2 lock content otherwise unchanged
