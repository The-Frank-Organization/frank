...
**PLAN_LOCK_ID:** `s1-slice-1-plan` · **DESIGN_LOCK_ID:** `s1-slice-1-design` (r4, main@3882763; pair-approved at r2 `…-152445`, r3 = guide-sanctioned should-fix folds, r4 = plan-review envelope fix) · **Owner:** s1-core · **Date:** 2026-07-03 · **Rev:** r2 (plan-review blockers 1+2 folded)
