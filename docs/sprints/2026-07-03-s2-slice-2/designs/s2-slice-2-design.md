...
**Status:** r2 — r1 drafted against dispatch r2 (`.relays/s2/s2-core-design/DESIGN-orchestrator-planner-20260704-005310.md`, GRILL_REQUIRED: yes) + the de-provision supplement (`…-005315.md`); operator grill run 2026-07-04, GRILL_LOCK at §8 (`s2-grill-s2-core`); r2 = the two review folds (§9) from `DESIGN-REVIEW-implementer-20260704-014646.md` (must-revise: F1 capability split, F2 durable-fact source), resent for re-review on the same DESIGN_DOC_ID
