...
**Basis:** reconciled paired audits (RECONCILE.md 2026-07-04 entry; planner `s2-core-audit/AUDIT-planner-20260704-003144.md` + implementer `…-002839.md`); m-7 guide answers (`../.relays/s2/s2-guide-q1/SITREP-planner-20260704-004750.md` — Q1=(a), Q2=(i), both from locked text); the s2-dispatch charter (`../.relays/s2/s2-dispatch/PLAN-orchestrator-planner-20260703-223913.md`).
...
Resolved decisions:
- S2 GC target scope — drained journal segments ONLY; rendered-projection compaction NOT built, documented dormant (no definable "old" membership under the current release's retain-everything) — source operator (2026-07-04, "lets just do journals only, and then document that we did NOT touch rendered copies")
