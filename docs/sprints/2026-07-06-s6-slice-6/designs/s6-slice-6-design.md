...
**DESIGN_DOC_ID:** `s6-slice-6-design` · **Rev:** r2 (GRILL FOLDED — §18 carries the GRILL_LOCK `s6-grill-s6-core`; the dispatch grill condition is satisfied; ready for the v2.8.5 DESIGN-REVIEW)
...
*Rev log: r1 provisional pre-grill → r2 GRILL FOLDED (§18 `s6-grill-s6-core`; six operator rows resolved 2026-07-07; §5/§7/§10/§12/§14.3/§16 grill-locked; ready for the v2.8.5 DESIGN-REVIEW).*
