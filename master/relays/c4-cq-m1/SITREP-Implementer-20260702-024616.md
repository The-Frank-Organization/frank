...
- It must preserve m-2 section 4 send ordering: Step-1 = store + form + lineage, with observe-as-send reserved for Step-2 and not required for Step-1 (`master/domains/m-2-forms-determinism/design/2026-06-28-v3-form-schema-design.md:70-75`).
...
- `python3 /Users/jack/.codex/skills/tools/relay-lint.py master/relays/c4-cq-m1/SITREP-Implementer-20260702-024616.md` - OK (`OK master/relays/c4-cq-m1/SITREP-Implementer-20260702-024616.md`)
