...
- Phase scope is explicit read-only audit, with no edits, branches, code, `pcode/`, spike, Step-1 PLAN, or implementation
  authority (`:18`, `:57-67`).
- The audit corpus matches the approved m-7 boot corpus: v2.8.8, jcode, claude-code, runtime research, crash-atomicity
...
- `python3 /Users/jack/.codex/skills/tools/relay-lint.py master/relays/c4-audit-m-7/AUDIT-orchestrator-planner-20260701-153627.md` -- OK
- `python3 /Users/jack/.codex/skills/tools/relay-lint.py master/relays/c4-audit-m-7/RECONCILE-orchestrator-reviewer-20260701-154017.md` -- OK
