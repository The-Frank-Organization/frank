...
- `python3 /Users/jack/.codex/skills/tools/relay-lint.py master/relays/c6-close/RECONCILE-orchestrator-planner-20260702-212929.md` - OK.
- `for d in master/relays/c6-fix-m-{1,2,3,4,5,6,7}; do python3 /Users/jack/.codex/skills/tools/relay-lint.py --relay-root "$d"; done` - OK for all seven roots.
