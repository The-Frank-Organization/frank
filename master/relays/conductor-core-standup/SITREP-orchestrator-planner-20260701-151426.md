...
- `python3 /Users/jack/.claude/skills/tools/relay-lint.py master/relays/conductor-core-standup/SITREP-orchestrator-planner-20260701-151426.md` — OK
- `python3 /Users/jack/.claude/skills/tools/relay-lint.py --relay-root master/relays/conductor-core-standup` — OK (dispatch-scoped; `master/relays/INDEX.md` is the charter's lint-exempt append-only index)
