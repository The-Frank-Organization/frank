...
Reconciled position:
- For v3.0 candidate vocabulary, remove literal `actuator` from the primary `seat_archetype` list.
...
- Whether `research_synthesis` and `qa_review` are v3.0 `slot_in` values or Step-5 workflow/template tags.
...
Tests / verification:
- E2: `python3 /Users/jack/.codex/skills/tools/relay-lint.py master/relays/c3-audit-m-5/RECONCILE-implementer-20260630-120346.md` passed.
- E2: `python3 /Users/jack/.codex/skills/tools/relay-lint.py --relay-root=master/relays master/relays/c3-audit-m-5/RECONCILE-implementer-20260630-120346.md` returned `OK` for this relay and expected root noise for lint-exempt `INDEX.md`.
