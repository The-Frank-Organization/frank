...
- **Dissolved-linter replay (S1-minimal, F1):** run the historical v2.8.8 lint failures **the MVP FieldSpec covers** through the MVP validator; confirm each is caught-or-genuinely-obsolete. The **full** "~33 checks dissolve" replay is an **S3** gate, not S1's.
