...
- **Q4 — scope (m-3 implementer's open Q).** Is the observation / `observed_evidence_ref` required on **all** routing decisions, only **benchmark/v3.1 samples**, or only **deviations**?
