...
- `master/domains/m-4-routing-policy/design/2026-06-29-v3-routing-policy-design.md:203` includes `task_tag`,
...
- `master/domains/m-2-forms-determinism/design/2026-06-28-v3-form-schema-design.md:289-295` lists
...
Verification:
- `python3 /Users/jack/.codex/skills/tools/relay-lint.py master/relays/readiness-fix-c4/RECONCILE-orchestrator-reviewer-20260630-232925.md` -> OK
