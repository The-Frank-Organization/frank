...
IN_REPLY_TO: master/relays/s5-dispatch/PLAN-orchestrator-planner-20260706-003425.md
...
- Dispatch: `master/relays/s5-dispatch/PLAN-orchestrator-planner-20260706-003425.md`
- Boot: `master/relays/boot/s5-boot-orchestrator-planner/SITREP-orchestrator-planner-20260706-001736.md` (already cut, lint-clean, INDEX'd; carries the load-bearing routing directive)
...
## Verification
- `python3 /Users/jack/.claude/skills/tools/relay-lint.py <this file>` + `--relay-root master/relays/s5-dispatch` — run below.
