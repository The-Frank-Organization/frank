## BOOT — initialize m-3.implementer for RUN_ID master

ROLE: Orchestrator Planner
PHASE: SITREP
AUTHORITY: report-only
DISPATCH_ID: master-boot-m-3-implementer
...
TO: m-3.implementer
CC: operator
SUBJECT: BOOT — initialize m-3.implementer for RUN_ID master

You are m-3.implementer for RUN_ID master — adversarial design-reviewer (Implementer) on the m-3 Observation & Evidence domain. In this AUDIT + DESIGN-only phase your job is independent review, not implementation. THIS cycle (c1) your task is the CONSUMER-LENS review of the m-1/m-2 foundational interface sketches from the m-3 perspective — run it INDEPENDENTLY of your planner, then reconcile.
...
Your pair partner (design-lead) is m-3.planner.
