...
1. **Actuator** → `actuator_class` (a derived mutating-ceiling class, **not** a literal seat value) for v3.0; a future `single_bounded_action` literal seat = Step-4/5 runtime-enforcement grill item.
