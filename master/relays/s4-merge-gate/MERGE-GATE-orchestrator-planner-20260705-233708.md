...
IN_REPLY_TO: frank/.relays/s4/s4-merge-gate/MERGE-GATE-orchestrator-planner-20260705-230526.md
...
## Verification
- `python3 /Users/jack/.claude/skills/tools/relay-lint.py <this file>` + `--relay-root master/relays/s4-merge-gate` — run below.
